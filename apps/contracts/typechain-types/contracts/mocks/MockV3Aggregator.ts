...
export interface MockV3AggregatorInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "updateAnswerAndTimestamp",
...
export interface MockV3Aggregator extends BaseContract {
  ...
  updateAnswerAndTimestamp: TypedContractMethod<
    [newAnswer: BigNumberish, newUpdatedAt: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "updateAnswerAndTimestamp"
  ): TypedContractMethod<
    [newAnswer: BigNumberish, newUpdatedAt: BigNumberish],
    [void],
    "nonpayable"
